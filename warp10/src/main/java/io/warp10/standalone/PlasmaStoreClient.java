...
public class PlasmaStoreClient implements StoreClient {
  ...
  @Override
  public GTSDecoderIterator fetch(ReadToken token, List<Metadata> metadatas, long now, long timespan, boolean fromArchive, boolean writeTimestamp, final int preBoundary, final int postBoundary) {
    return null;
  }
  @Override
