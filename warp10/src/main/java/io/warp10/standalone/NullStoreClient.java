...
public class NullStoreClient implements StoreClient {
  ...
  @Override
  public GTSDecoderIterator fetch(ReadToken token, java.util.List<io.warp10.continuum.store.thrift.data.Metadata> metadatas, long now, long timespan, boolean fromArchive, boolean writeTimestamp, final int preBoundary, final int postBoundary) {
    return null;
  }
