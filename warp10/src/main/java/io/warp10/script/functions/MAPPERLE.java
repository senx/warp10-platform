...
import io.warp10.script.aggregator.FirstLE;

public class MAPPERLE extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public MAPPERLE(String name) {
    super(name);
  }  
