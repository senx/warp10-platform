...
/**
 * Get the east hhcode of the given hhcode at the given resolution.
 */
public class HHCODEEAST extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODEEAST(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    long eastHHCode = HHCodeHelper.eastHHCode(hh, res);
    stack.push(HHCodeHelper.toString(eastHHCode,res));
    return stack;
  }
}
