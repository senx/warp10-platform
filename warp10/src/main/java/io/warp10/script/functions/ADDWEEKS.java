...
/**
 * Adds a number of weekd to a timestamp
 */
public class ADDWEEKS extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  
  public ADDWEEKS(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (!(top instanceof Long)) {
      throw new WarpScriptException(getName() + " expects a number of weeks on top of the stack.");
    }
    
    int weeks = ((Number) top).intValue();
