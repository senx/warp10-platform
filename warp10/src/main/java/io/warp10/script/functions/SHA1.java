...
/**
 * Message Digest of a byte array with the cryptographic hash function SHA-1 (Secure Hash Algorithm 1)
 */
public class SHA1 extends NamedWarpScriptFunction implements WarpScriptStackFunction {
