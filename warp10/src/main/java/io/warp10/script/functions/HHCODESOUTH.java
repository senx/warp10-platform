...
/**
 * Get the south hhcode of the given hhcode at the given resolution.
 */
public class HHCODESOUTH extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODESOUTH(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    long southHHCode = HHCodeHelper.southHHCode(hh, res);
    stack.push(HHCodeHelper.toString(southHHCode, res));
    return stack;
  }
}
