...
/**
 * Get the north east hhcode of the given hhcode at the given resolution.
 */
public class HHCODENORTHEAST extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODENORTHEAST(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    long northEastHHCode = HHCodeHelper.northEastHHCode(hh, res);
    stack.push(HHCodeHelper.toString(northEastHHCode,res));
    return stack;
  }
}
