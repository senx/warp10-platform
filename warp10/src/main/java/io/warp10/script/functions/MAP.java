...
public class MAP extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (nseries == params.size() || !(params.get(nseries) instanceof WarpScriptMapper) && !(params.get(nseries) instanceof WarpScriptMapperFunction) && !(params.get(nseries) instanceof Macro)) {
