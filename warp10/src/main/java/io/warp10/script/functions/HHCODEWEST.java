...
/**
 * Get the west hhcode of the given hhcode at the given resolution.
 */
public class HHCODEWEST extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODEWEST(String name) {
    super(name);
  }
