...
public class CHRONOSTATS extends NamedWarpScriptFunction implements WarpScriptStackFunction {
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (null == stats) {
      ...
      LinkedHashMap<String,LinkedHashMap<String,Long>> result = new LinkedHashMap<String,LinkedHashMap<String,Long>>();
      for (Map.Entry<String,AtomicLong[]> entry: stats.entrySet()) {
        LinkedHashMap<String,Long> macro_result = new LinkedHashMap<String,Long>();
