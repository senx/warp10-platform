...
/**
 * Get the south west hhcode of the given hhcode at the given resolution.
 */
public class HHCODESOUTHWEST extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODESOUTHWEST(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    long southWestHHCode = HHCodeHelper.southWestHHCode(hh, res);
    stack.push(HHCodeHelper.toString(southWestHHCode, res));
    return stack;
  }
}
