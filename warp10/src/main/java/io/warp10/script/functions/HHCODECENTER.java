...
/**
 * Get the center (lat, lon) of the given hhcode at the given resolution.
 */
public class HHCODECENTER extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public HHCODECENTER(String name) {
    super(name);
  }
