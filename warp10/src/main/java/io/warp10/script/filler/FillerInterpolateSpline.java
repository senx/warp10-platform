...
public class FillerInterpolateSpline extends NamedWarpScriptFunction implements WarpScriptUnivariateFillerFunction {

  public FillerInterpolateSpline(String name) {
    super(name);
  }
