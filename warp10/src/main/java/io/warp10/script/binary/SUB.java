  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    if (op2 instanceof Number && op1 instanceof Number) {
      if (op1 instanceof BigDecimal || op2 instanceof BigDecimal) {
        stack.push(TOBD.toBigDecimal(getName(), TOBD.toBigDecimal(getName(), op1).subtract(TOBD.toBigDecimal(getName(), op2))));
      ...
      if (gts1.getType() == TYPE.LONG && gts2.getType() == TYPE.LONG) { // both long => long substraction
