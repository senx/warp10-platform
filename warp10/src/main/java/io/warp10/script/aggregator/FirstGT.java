 ...
 *
 */
public class FirstGT extends NamedWarpScriptFunction implements WarpScriptAggregatorFunction, WarpScriptMapperFunction, WarpScriptReducerFunction, WarpScriptBucketizerFunction {
  ...
  public FirstGT(String name, long threshold) {
    super(name);
    this.type = TYPE.LONG;
    this.lthreshold = threshold;
  }
  
  public FirstGT(String name, double threshold) {
    super(name);
    this.type = TYPE.DOUBLE;
    this.dthreshold = threshold;
  }
  
  public FirstGT(String name, String threshold) {
    super(name);
