...
/**
 * Return the first value equal to a threshold
 *
 */
public class FirstEQ extends NamedWarpScriptFunction implements WarpScriptAggregatorFunction, WarpScriptMapperFunction, WarpScriptReducerFunction, WarpScriptBucketizerFunction {
  ...
  public FirstEQ(String name, long threshold) {
    super(name);
    this.type = TYPE.LONG;
    this.lthreshold = threshold;
  }
  
  public FirstEQ(String name, double threshold) {
    super(name);
    this.type = TYPE.DOUBLE;
    this.dthreshold = threshold;
  }

  public FirstEQ(String name, String threshold) {
    super(name);
    this.type = TYPE.STRING;
    this.sthreshold = threshold;
  }
  
  public FirstEQ(String name, boolean threshold) {
    super(name);
