...
public class FilterAnyGT extends NamedWarpScriptFunction implements WarpScriptFilterFunction {
  ...
  public static class Builder extends NamedWarpScriptFunction implements WarpScriptStackFunction {
    ...
    public Object apply(WarpScriptStack stack) throws WarpScriptException {
      ...
      stack.push(new FilterAnyGT(getName(), threshold, this.complementSet));
      return stack;
    }
  }

  public FilterAnyGT(String name, Object threshold, boolean complementSet) throws WarpScriptException {
    super(name);
