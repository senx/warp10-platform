...
public class FFT {
  ...
  public static List<Object> fft(GeoTimeSerie gts, boolean complex) throws WarpScriptException {
    ...
    //
    // Do a trivial test to check if the number of values is a power of 2.
    // This should be sufficient in the general case, i.e. GTS generated by WarpScript.
    ...
    if ((gts.values & (gts.values - 1)) != 0) {
      throw new WarpScriptException("FFT can only be applied to geo time series which contain a number of values which is a power of 2.");
    }
