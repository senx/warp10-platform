...
public class FDBSTATUS extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public FDBSTATUS(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push(FDBUtils.getStatus(context));
